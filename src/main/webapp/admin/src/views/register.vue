  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(0, 150, 136, 1);fontSize:28px;">旅游信息管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="身份证号码" class="input" v-if="tableName=='huiyuan'">
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                                                                            ...
                                                                                                                                                            if(`huiyuan` == this.tableName && this.ruleForm.shenfenzhenghaoma&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghaoma))){
