<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="酒店编号" prop="jiudianbianhao">
            <el-input v-model="ruleForm.jiudianbianhao" 
                placeholder="酒店编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiudianbianhao" label="酒店编号" prop="jiudianbianhao">
              <el-input v-model="ruleForm.jiudianbianhao" 
                placeholder="酒店编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="酒店名称" prop="jiudianmingcheng">
              <el-input v-model="ruleForm.jiudianmingcheng" 
                placeholder="酒店名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒店信息" prop="jiudianxinxi">
          <el-input v-model="ruleForm.jiudianxinxi" 
              placeholder="酒店信息" clearable  :readonly="ro.jiudianxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒店信息" prop="jiudianxinxi">
              <el-input v-model="ruleForm.jiudianxinxi" 
                placeholder="酒店信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jiudiantupian" label="酒店图片" prop="jiudiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiudiantupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="酒店位置" prop="jiudianweizhi">
          <el-input v-model="ruleForm.jiudianweizhi" 
              placeholder="酒店位置" clearable  :readonly="ro.jiudianweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="酒店位置" prop="jiudianweizhi">
              <el-input v-model="ruleForm.jiudianweizhi" 
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiudianmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='jiudianxinxi'){
            this.ruleForm.jiudianxinxi = obj[o];
	    this.ro.jiudianxinxi = true;
            continue;
          }
	            	            if(o=='jiudiantupian'){
	    ...
	    this.ro.jiudiantupian = true;
            continue;
	            	            ...
	            	            if(o=='jiudianweizhi'){
            this.ruleForm.jiudianweizhi = obj[o];
	    this.ro.jiudianweizhi = true;
            continue;
          }
	            	            if(o=='faburiqi'){
