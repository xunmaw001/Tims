<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="公告编号" prop="gonggaobianhao">
            <el-input v-model="ruleForm.gonggaobianhao" 
                placeholder="公告编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gonggaobianhao" label="公告编号" prop="gonggaobianhao">
              <el-input v-model="ruleForm.gonggaobianhao" 
                placeholder="公告编号" readonly></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='gonggaobianhao'){
            this.ruleForm.gonggaobianhao = obj[o];
	    this.ro.gonggaobianhao = true;
            continue;
          }
	            	            if(o=='gonggaobiaoti'){
