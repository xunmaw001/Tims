          ...
          <el-form-item class="input" label="景点名称" prop="jingdianmingcheng">
              <el-input v-model="ruleForm.jingdianmingcheng" 
                placeholder="景点名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="景点信息" prop="jingdianxinxi">
          <el-input v-model="ruleForm.jingdianxinxi" 
              placeholder="景点信息" clearable  :readonly="ro.jingdianxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="景点信息" prop="jingdianxinxi">
              <el-input v-model="ruleForm.jingdianxinxi" 
                placeholder="景点信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jingdiantupian" label="景点图片" prop="jingdiantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jingdiantupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="线路信息" prop="xianluxinxi">
          <el-input v-model="ruleForm.xianluxinxi" 
              placeholder="线路信息" clearable  :readonly="ro.xianluxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="线路信息" prop="xianluxinxi">
              <el-input v-model="ruleForm.xianluxinxi" 
                placeholder="线路信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jingdianmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='jingdianxinxi'){
            this.ruleForm.jingdianxinxi = obj[o];
	    this.ro.jingdianxinxi = true;
            continue;
          }
	            	            if(o=='jingdiantupian'){
	    ...
	    this.ro.jingdiantupian = true;
            continue;
	            	            ...
	            	            if(o=='xianluxinxi'){
            this.ruleForm.xianluxinxi = obj[o];
	    this.ro.xianluxinxi = true;
            continue;
          }
	            	            if(o=='faburiqi'){
